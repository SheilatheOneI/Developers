  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-0">
      ...
      >
        ...
        <p className="text-lg text-center mb-1">Forgot Your Password?</p>
        <p className="text-center text-md mb-3 text-gray-400">
        ...
        <input
          ...
          className="w-full py-3 px-6 border rounded-full"
        />
        {error && <p className="text-red-500  pl-6 text-sm">{error}</p>}
        <button
          type="submit"
          className="w-full bg-[#1C5D99] text-white py-3 rounded-full hover:bg-[#164973] transition-colors mt-4"
        >
          Send Reset Link
        </button>
      </form>
